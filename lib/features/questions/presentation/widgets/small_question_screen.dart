...
import 'package:mind/features/questions/presentation/widgets/small_quiz_question.dart';

import '../../../../utils/constants/colors.dart';
import '../../../../utils/constants/sizes.dart';
import '../controllers/quiz_controller.dart';

class CustomSmallQuestionScreen extends StatelessWidget {
  const CustomSmallQuestionScreen({super.key, required this.quizController});
          ...
          SizedBox(
            ...
            child: PageView.builder(
              ...
              itemBuilder: (context, index) {
                return CustomSmallQuizQuestion(
