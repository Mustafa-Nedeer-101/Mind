...
class CustomAudioPlayersManager extends GetxController
  ...
  static void initialize() {
    WidgetsBinding.instance.addObserver(CustomAudioPlayersManager());
  }
  ...
  static void playRandomSong() async {
    if (musicEnabled) {
      ...
      if (canPlay) {
        _audioPlayer.play(AssetSource(_songs[songIndex]), volume: 0.8);
      }
    }
  }
  ...
  void onClose() {
    ...
    WidgetsBinding.instance.removeObserver(CustomAudioPlayersManager());
    super.onClose();
  }
}
